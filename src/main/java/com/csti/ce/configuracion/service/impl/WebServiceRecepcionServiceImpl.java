...
public class WebServiceRecepcionServiceImpl implements WebServiceRecepcionService {
    ...
    public List<Parametro> getParametros(String sociedad) {
        ...
        list.add(parametroDAOHibernate.getParametroByCampo(parametroHigh, ParametroConstants.RECEPCION_WSDL));
        list.add(parametroDAOHibernate.getParametroByCampo(parametroHigh, ParametroConstants.RECEPCION_INTENTOS));
        list.add(parametroDAOHibernate.getParametroByCampo(parametroHigh, ParametroConstants.RECEPCION_ESPERA));
        return list;
    }
    ...
    public Response updateParametros(Map<String, Object> parametros, String sociedad) {
        ...
        try {
            ...
            response.setMessage(MensajeConstante.WEB_SERVICE_RECEPCION_UPDATE);
            response.setSuccess(true);
            return response;
        } catch (Exception e) {
            response.setMessage(MensajeConstante.WEB_SERVICE_RECEPCION_ERROR);
