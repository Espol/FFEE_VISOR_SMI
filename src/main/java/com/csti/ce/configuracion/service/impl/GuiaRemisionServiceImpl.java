...
public class GuiaRemisionServiceImpl implements GuiaRemisionService {
    ...
    public Response updateParametros(Map<String, Object> parametros, String sociedad) {
        ...
        try {
            ...
            response.setMessage(MensajeConstante.GUIAREMISION_UPDATE);
            response.setSuccess(true);
            return response;
        } catch (Exception e) {
            response.setMessage(MensajeConstante.GUIAREMISION_ERROR);
    ...
    public List<Parametro> getParametros(String sociedad) {
        ...
        list.add(parametroDAOHibernate.getParametroByCampo(parametroHigh, ParametroConstants.GUIAREMISION_PATH_AUTORIZACION));
        list.add(parametroDAOHibernate.getParametroByCampo(parametroHigh, ParametroConstants.GUIAREMISION_PATH_RECHAZADO));
        list.add(parametroDAOHibernate.getParametroByCampo(parametroHigh, ParametroConstants.GUIAREMISION_PATH_CONTINGENCIA));
        list.add(parametroDAOHibernate.getParametroByCampo(parametroHigh, ParametroConstants.GUIAREMISION_PATH_INCONSISTENTE));
        list.add(parametroDAOHibernate.getParametroByCampo(parametroHigh, ParametroConstants.GUIAREMISION_PATH_REPORTE));
        list.add(parametroDAOHibernate.getParametroByCampo(parametroHigh, ParametroConstants.GUIAREMISION_PATH_PDF));
        list.add(parametroDAOHibernate.getParametroByCampo(parametroHigh, ParametroConstants.GUIAREMISION_PATH_XML));
        list.add(parametroDAOHibernate.getParametroByCampo(parametroHigh, ParametroConstants.GUIAREMISION_PATH_XSD_100));
        list.add(parametroDAOHibernate.getParametroByCampo(parametroHigh, ParametroConstants.GUIAREMISION_PATH_XSD_110));
