...
public class NotaCreditoServiceImpl implements NotaCreditoService {
    ...
    public List<Parametro> getParametros(String sociedad) {
        ...
        list.add(parametroDAOHibernate.getParametroByCampo(parametroHigh, ParametroConstants.NOTACREDITO_PATH_AUTORIZACION));
        list.add(parametroDAOHibernate.getParametroByCampo(parametroHigh, ParametroConstants.NOTACREDITO_PATH_RECHAZADO));
        list.add(parametroDAOHibernate.getParametroByCampo(parametroHigh, ParametroConstants.NOTACREDITO_PATH_CONTINGENCIA));
        list.add(parametroDAOHibernate.getParametroByCampo(parametroHigh, ParametroConstants.NOTACREDITO_PATH_INCONSISTENTE));
        list.add(parametroDAOHibernate.getParametroByCampo(parametroHigh, ParametroConstants.NOTACREDITO_PATH_REPORT));
        list.add(parametroDAOHibernate.getParametroByCampo(parametroHigh, ParametroConstants.NOTACREDITO_PATH_PDF));
        list.add(parametroDAOHibernate.getParametroByCampo(parametroHigh, ParametroConstants.NOTACREDITO_PATH_XML));
        list.add(parametroDAOHibernate.getParametroByCampo(parametroHigh, ParametroConstants.NOTACREDITO_PATH_XSD_100));
        list.add(parametroDAOHibernate.getParametroByCampo(parametroHigh, ParametroConstants.NOTACREDITO_PATH_XSD_110));
        return list;
    }
    ...
    public Response updateParametros(Map<String, Object> parametros, String sociedad) {
        ...
        try {
            ...
            response.setMessage(MensajeConstante.NOTACREDITO_UPDATE);
            response.setSuccess(true);
            return response;
        } catch (Exception e) {
            response.setMessage(MensajeConstante.NOTACREDITO_ERROR);
