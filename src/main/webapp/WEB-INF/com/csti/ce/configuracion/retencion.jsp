<%-- 
    Document   : retencion
    Created on : 11-may-2014, 12:54:35
    Author     : User
--%>
...
<html>
    <head>
        ...
        <title>Parametro Retención</title>
    </head>
    <body>
        <h3>CONFIGURACI&Oacute;N DE RETENCI&Oacute;N</h3>
        <hr>
        <div class="container-frm">
            <form id="ff-rtParametro" method="post" >
                <fieldset>
                    ...
                    <div align="center">
                        <table cellpadding="5">
                            ...
                            <tr>
                                ...
                                <td><input id="id-rechazado" type="hidden" name="id-rechazado"></input></td>
                            ...
                            <tr>
                                ...
                                <td><input id="id-inconsistencia" name="id-inconsistente" type="hidden"></input></td>
                ...
                <div style="text-align:center;padding:15px">
                    <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-save'" type="button" onclick="submitRetencion()">Guardar</a>
                </div>
            </form>
        </div>
        <script type="text/javascript">
            $("#document").ready(function() {
                /*$("#ff-rtParametro").form('load', '${pageContext.request.contextPath}/view/config/retencion/load');*/
                $.ajax({type: 'POST',
                    beforeSend: function() {
                        $.fn.loading.open("Cargando","Cargando Parametros Retención");
                    },
                    url: '${pageContext.request.contextPath}/view/config/retencion/load',
                    dataType: 'json',
                    success: function(response, textStatus, jqXHR) {
                        $("#ff-rtParametro").form('load', response.data);
                        $.fn.loading.close();
                    },
                    statusCode: {
                        404: function() {
            ...
            function submitRetencion() {
                $.fn.loading.open("Actualizando", "Actualizando Parametros Retención");
                $('#ff-rtParametro').form('submit', {
                    url: '${pageContext.request.contextPath}/view/config/retencion/edit',
