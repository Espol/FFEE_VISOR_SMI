<%-- 
    Document   : newjspNotaDebitoParametro
    Created on : 11-may-2014, 12:46:12
    Author     : User
--%>
...
<html>
    <head>
        ...
        <title>Parametros Nota Debito</title>
    </head>
    <body>
        <h3><strong>CONFIGURACI&Oacute;N DE NOTA DE DEBITO</strong></h3>
        <hr>
        <div class="container-frm">
            <form id="ff-ndParametro" method="post" >
                <fieldset>
                ...
                <div style="text-align:center;padding:15px">
                    <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-save'" type="button" onclick="submitNotaDebito()">Guardar</a>
                </div>
            </form>
            <script type="text/javascript">
                $(document).ready(function() {
                    /*$("#ff-ndParametro").form('load', '${pageContext.request.contextPath}/view/config/notadebito/load');*/
                    $.ajax({type: 'POST',
                    beforeSend: function() {
                        $.fn.loading.open("Cargando","Cargando Parametros Nota Debito");
                    },
                    url: '${pageContext.request.contextPath}/view/config/notadebito/load',
                    dataType: 'json',
                    success: function(response, textStatus, jqXHR) {
                        $("#ff-ndParametro").form('load',response.data);
                        $.fn.loading.close();
                    },
                    statusCode: {
                        404: function() {
                ...
                function submitNotaDebito() {
                    $.fn.loading.open("Actualizando","Actualizando Parametros Nota Debito");
                    $('#ff-ndParametro').form('submit', {
                        url: '${pageContext.request.contextPath}/view/config/notadebito/edit',
