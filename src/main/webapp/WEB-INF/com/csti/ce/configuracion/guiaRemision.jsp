<%-- 
    ...
    Created on : 11-may-2014, 12:49:11
    Author     : User
--%>
...
<html>
    <head>
        ...
        <title>Parametros Guia de Remisión</title>
    </head>
    <body>
        <h3><big>CONFIGURACI&Oacute;N DE GU&Iacute;A DE REMISI&Oacute;N</big></h3>
        <hr>
        <div class="container-frm">
            <form id="ff-grParametro" method="post" >
                <fieldset>
                ...
                <fieldset>
                    <legend><strong>Esquema de validaci&oacute;n: XSD</strong></legend>
                    <div align="center">
                        <table cellpadding="5">
                            <tr>
                ...
                <div style="text-align:center;padding:15px">
                    <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-save'" type="button" onclick="submitGuiaRemision()">Guardar</a>
                </div>
            </form>
        </div>
        <script type="text/javascript">
            $("#document").ready(function() {
                /*$("#ff-grParametro").form('load', '${pageContext.request.contextPath}/view/config/guiaremision/load');*/
                $.ajax({type: 'POST',
                    beforeSend: function() {
                        $.fn.loading.open("Cargando","Cargando Parametros Guia Remisión");
                    },
                    url: '${pageContext.request.contextPath}/view/config/guiaremision/load',
                    dataType: 'json',
                    success: function(response, textStatus, jqXHR) {
                        $("#ff-grParametro").form('load', response.data);
                        $.fn.loading.close();
                    },
                    statusCode: {
                        404: function() {
            ...
            function submitGuiaRemision() {
                $.fn.loading.open("Actualizando","Actualizando Parametros Firma Electronica");
                $('#ff-grParametro').form('submit', {
                    url: '${pageContext.request.contextPath}/view/config/guiaremision/edit',
