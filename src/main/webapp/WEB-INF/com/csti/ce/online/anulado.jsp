...
<html>
    ...
    <body>
        <table id="dg-anulado" class="easyui-datagrid" style="height:475px;min-width: 710px" pagination="true" 
               data-options="border:false,
               url:'${pageContext.request.contextPath}/view/anulado/comprobante/load',
               striped:true,
               idField:'idDoc',
               rownumbers: true,
               singleSelect:true,
               pageSize:20" toolbar="#searchAnulado">
        ...
        <div id="searchAnulado" style="padding:5px">           
                   <b>Busquedas por:</b>
        ...
        <script type="text/javascript">
            ...
            var dgAutorizar = $("#dg-anulado");
            dgAutorizar.datagrid({
                queryParams: {
                    tipoDoc: $("#tipoDocAnulado").val(),
                    fechaIni: f_1,
                    fechaFinal: f_td,
                    nroSri: $("#searchAnulado #nroSri").val(),
                    nroReferencia: $("#searchAnulado #nroReferencia").val(),
                    codInterlocutor: $("#searchAnulado #codInterlocutor").val()
                }
            });
            $('#searchAnulado #fechaInicialAnulado').val(f_1);
            $('#searchAnulado #fechaFinalAnulado').val(f_td);
            ...
            function buscarAnulados() {
                $("#dg-anulado").datagrid('reload', {
                    tipoDoc: $("#searchAnulado input[name=tipoDocAnulado]").val(),
                    fechaIni: $("#searchAnulado #fechaInicialAnulado").datebox('getValue'),
                    fechaFinal: $("#searchAnulado #fechaFinalAnulado").datebox('getValue'),
                    nroSri: $("#searchAnulado #nroSri").val(),
                    nroReferencia: $("#searchAnulado #nroReferencia").val(),
                    codInterlocutor: $("#searchAnulado #codInterlocutor").val()
                });
